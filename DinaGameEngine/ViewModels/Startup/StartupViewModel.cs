            ...
            switch (CurrentState)
            {
                case StartupState.RecentProjects:
                    FooterButtons.Buttons.Add(new ButtonDescriptor
                    {
                        ...
                        Label = LocalizationManager.GetTranslation("Startup_NewProject"),
                        Command = GoToNewProjectCommand,
                        Role = ButtonRole.Neutral,
                        ContentHorizontalAlignment = ControlHorizontalAlignment.Center,
                    });
                    FooterButtons.Buttons.Add(new ButtonDescriptor
                    {
                        Icon = DinaIcon.Open.ToGlyph(),
                        Label = LocalizationManager.GetTranslation("Startup_Open"),
